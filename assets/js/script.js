$(document).ready(function() {
    ...
    $('#main.home').each(function() {
        ...
        $('.services ul li').mouseover(function(){
        ...
        $('.services ul li').mouseout(function(){
            var rel = $(this).find('a').attr('rel');
            if(!selected){
    ...
    $('#main.contactus').each(function() {
        ...
        $('#contact-map .city').bind({
            click: function() 
            {
                if($(this).children().is('.active'))
                {
                    ...
                    $('#contact-modal').removeClass('onSydney');
                }
                else 
                {
                    $('.map-mark').removeClass('active');
        ...
        $('#contact-map #sydney').click(function() {
        	$(this).next('#contact-modal').toggleClass('onSydney');
        });
